...
The storage class where an `R2Object` is stored in. The available storage classes are `Standard` and `InfrequentAccess`. Refer to [Storage Classes](https://developers.cloudflare.com/r2/buckets/storage-classes/)
